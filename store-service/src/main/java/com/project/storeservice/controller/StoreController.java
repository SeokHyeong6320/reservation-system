...
public class StoreController {
    ...
    public ResponseEntity<?> searchStoreSortByName(Pageable pageable) {
        ...
        Page<StoreResponse.StoreInfoResponse> list =   // 순환참조 방지 위해 PageResponse 형태로 반환
                storeSearchService.sortByName(pageable).map(StoreResponse.StoreInfoResponse::fromDto);
    ...
    public ResponseEntity<?> searchStoreSortByStar(Pageable pageable) {
        ...
        Page<StoreResponse.StoreInfoResponse> list = storeSearchService.sortByStar(pageable).map(StoreResponse.StoreInfoResponse::fromDto);
    ...
    public ResponseEntity<?> searchStoreSortByDistance(
        ...
        Page<StoreResponse.StoreInfoResponse> list = storeSearchService.sortByDistance(lat, lon, pageable).map(StoreResponse.StoreInfoResponse::fromDto);
